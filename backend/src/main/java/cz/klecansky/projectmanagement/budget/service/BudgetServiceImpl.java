...
public class BudgetServiceImpl implements BudgetService {
    ...
    @NonNull BudgetCategoryRepository budgetCategoryRepository;
    @NonNull BudgetItemRepository budgetItemRepository;
    ...
    public Optional<BudgetCommand> getByProject(UUID id) throws NoSuchElementFoundException {
        return budgetRepository.findAll().stream().filter(budgetEntity -> budgetEntity.getProject().getId().equals(id)).map(budgetMapper::budgetEntityToBudgetCommand).findFirst();
    }
    ...
    public BudgetCategoryCommand createBudgetCategory(UUID id, BudgetCategoryCommand budgetCategoryCommand) {
        ...
        BudgetCategoryEntity budgetCategoryEntity = budgetCategoryMapper.budgetCategoryCommandToBudgetCategoryEntity(budgetCategoryCommand);
    ...
    public BudgetItemCommand createBudgetItem(UUID id, BudgetItemCommand budgetItemCommand) {
        ...
        BudgetCategoryEntity budgetCategoryEntity = budgetCategoryRepository.findById(id).orElseThrow(NoSuchElementFoundException::new);
    ...
    public BudgetCategoryCommand updateCategory(UUID id, BudgetCategoryCommand budgetCategoryCommand) {
        ...
        return budgetCategoryMapper.budgetCategoryEntityToBudgetCategoryCommand(budgetCategoryRepository.save(budgetCategoryEntity));
    }

    @Override
    public BudgetItemCommand updateItem(UUID id, BudgetItemCommand budgetItemCommand) {
        BudgetItemEntity budgetItemEntity = budgetItemRepository.findById(id).orElseThrow(NoSuchElementFoundException::new);
    ...
    public Optional<BudgetCategoryCommand> getCategory(UUID id) {
        return budgetCategoryRepository.findById(id).map(budgetCategoryMapper::budgetCategoryEntityToBudgetCategoryCommand);
    }
    ...
    public Optional<BudgetCategoryCommand> getItemCategory(UUID id) {
        BudgetItemEntity budgetItemEntity = budgetItemRepository.findById(id).orElseThrow(NoSuchElementFoundException::new);
        return Optional.of(budgetCategoryMapper.budgetCategoryEntityToBudgetCategoryCommand(budgetItemEntity.getBudgetCategory()));
    }
}
