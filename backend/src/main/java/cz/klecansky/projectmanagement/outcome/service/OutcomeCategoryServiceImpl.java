...
public class OutcomeCategoryServiceImpl implements OutcomeCategoryService {
    ...
    public OutcomeCategoryCommand create(OutcomeCategoryCommand outcomeCategoryCommand) {
        ...
        OutcomeCategoryEntity save = outcomeCategoryRepository.save(
                outcomeCategoryMapper.outcomeCategoryCommandToOutcomeCategoryEntity(outcomeCategoryCommand));
    ...
    public Optional<OutcomeCategoryCommand> get(UUID id) throws NoSuchElementFoundException {
        return outcomeCategoryRepository
                .findById(id)
                .map(outcomeCategoryMapper::outcomeCategoryEntityToOutcomeCategoryCommand);
    }
    ...
    public OutcomeCategoryCommand update(UUID id, OutcomeCategoryCommand outcomeCommand) {
        ...
        return outcomeCategoryMapper.outcomeCategoryEntityToOutcomeCategoryCommand(
