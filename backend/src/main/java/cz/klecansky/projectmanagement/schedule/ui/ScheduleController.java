...
public class ScheduleController {
    ...
    @NonNull ScheduleMapper scheduleMapper;
    @NonNull TaskScheduleMapper taskMapper;
    ...
    public ResponseEntity<?> getScheduleByProject(@PathVariable UUID id) throws NoSuchElementFoundException {
        return scheduleService.getByProject(id)
                .map(scheduleCommand -> ResponseEntity.ok(scheduleMapper.scheduleCommandToScheduleResponse(scheduleCommand)))
    ...
    public ResponseEntity<?> getRows(@PathVariable UUID id) throws NoSuchElementFoundException {
        return ResponseEntity.ok(scheduleService.getRows(id).stream().map(rowMapper::rowCommandToRowResponse).toList());
    }
    ...
    public ResponseEntity<SuccessResponse> createTask(@PathVariable UUID id, @RequestBody TaskRequest request) {
        ...
        return ResponseEntity.ok(SuccessResponse.builder().message("Task was successfully created.").data(scheduleMapper.scheduleCommandToScheduleResponse(createTask)).build());
    }
    ...
    public ResponseEntity<SuccessResponse> createRow(@PathVariable UUID id, @RequestBody RowRequest request) {
        ...
        return ResponseEntity.ok(SuccessResponse.builder().message("Row was successfully created.").data(scheduleMapper.scheduleCommandToScheduleResponse(createRow)).build());
    }
    ...
    public ResponseEntity<SuccessResponse> updateTask(@PathVariable UUID id, @RequestBody TaskRequest request) {
        ...
        return ResponseEntity.ok(SuccessResponse.builder().message("Task was successfully updated.").data(taskMapper.taskCommandToTaskResponse(updatedTask)).build());
    }
    ...
    public ResponseEntity<SuccessResponse> updateRow(@PathVariable UUID id, @RequestBody RowRequest request) {
        ...
        return ResponseEntity.ok(SuccessResponse.builder().message("Row was successfully updated.").data(rowMapper.rowCommandToRowResponse(updateRow)).build());
    }
    ...
    public ResponseEntity<SuccessResponse> deleteRow(@PathVariable UUID id) {
        ...
        return ResponseEntity.ok(SuccessResponse.builder().message("Row was successfully deleted.").build());
    }
}
