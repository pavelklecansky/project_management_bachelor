...
<div class="flex justify-between m-2">
    ...
    <div>
        ...
        <a class="mr-4" href={$url(`./${id}/create-task/${scheduleId}`)}>
            <CreateButton text={"Create new task"}/>
        </a>
        <a href={$url(`./${id}/create-row/${scheduleId}`)}>
            <CreateButton text={"Create new row"}/>
        </a>
        <a  href={$url(`./${id}/delete-row/${scheduleId}`)}>
            <CreateButton color="red" text={"Delete Row"}/>
        </a>
        <a  href={$url(`./${id}/edit-row/${scheduleId}`)}>
