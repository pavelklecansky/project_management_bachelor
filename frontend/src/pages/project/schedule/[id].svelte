<script lang="ts">
    ...
    import type {Schedule} from '../../../types/core.type';
    import {goto, params} from '@roxi/routify';
    import {error} from '../../../lib/notification';
    import ScheduleNav from "../../../components/schedule/ScheduleNav.svelte";
    import {writable} from 'svelte/store';
    import GanttOptions from "../../../components/schedule/GanttOptions.svelte";
    ...
    let options = {
        ...
        to: currentEnd,
        tableHeaders: [
            {title: "Project Schedule", property: "label", width: 140, type: "tree"}
        ],
        tableWidth: 240,
