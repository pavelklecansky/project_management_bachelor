...
export const createOrganization: (organization: Organization) => Promise<[Organization, any]> = async (project) => {
    const [res, error] = await apiRequest({
        endpointName: "organizations",
        method: "POST",
        body: project
...
export const updateOrganization: (organization: Organization) => Promise<[Organization, any]> = async (organization) => {
...
export const deleteOrganization: (id: string) => Promise<[Organization | null, any]> = async (id) => {
    const endpointName = `organizations/${id}`;
    const [res, error] = await apiRequest({
        endpointName,
        method: "DELETE",
