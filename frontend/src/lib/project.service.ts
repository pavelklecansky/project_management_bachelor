...
export const createProject: (project: Project) => Promise<[Project | null, any]> = async (
	project
) => {
	const [res, error] = await apiRequest({
		endpointName: 'projects',
...
export const addMember: (id: string, user: User) => Promise<[Project | null, any]> = async (
	id,
	user
) => {
...
export const deleteMember: (
	id: string,
	idMember: string
) => Promise<[Project | null, any]> = async (id, idMember) => {
...
export const addGroupMember: (id: string, group: Group) => Promise<[Project | null, any]> = async (
	id,
	group
) => {
...
export const addComment: (id: string, text: string) => Promise<[Project | null, any]> = async (
	id,
	text
) => {
...
export const deleteComment: (
	id: string,
	idComment: string
) => Promise<[Project | null, any]> = async (id, idComment) => {
...
export const updateProject: (project: Project) => Promise<[Project | null, any]> = async (
	project
) => {
