...
<ul class="mt-4">
	{#if isAdmin()}
		<div>
			<h3 class="px-6 py-1 inline-flex items-center w-full text-lg font-semibold text-gray-800">
				Admin
			</h3>
	...
	<div>
		<h3 class="px-6 py-3 inline-flex items-center w-full text-lg font-semibold text-gray-800">
			General
		</h3>
