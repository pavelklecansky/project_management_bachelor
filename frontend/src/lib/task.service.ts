...
export const addComment: (id: string, text: string) => Promise<[Task | null, any]> = async (
	id,
	text
) => {
...
export const deleteComment: (id: string, idComment: string) => Promise<[Task | null, any]> = async (
	id,
	idComment
) => {
