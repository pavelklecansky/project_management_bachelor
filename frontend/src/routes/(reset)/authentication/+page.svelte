...
<div>
	<h2 class="text-3xl font-bold text-center text-gray-700 dark:text-white">Welcome Back</h2>
	...
	<form on:submit|preventDefault={handleSubmit}>
		...
		<div class="flex items-center justify-between mt-4 mb-2">
			<a
				href={'./passwordReset'}
				class="text-sm text-gray-600 dark:text-gray-200 hover:text-gray-500">Forget Password?</a
			>
